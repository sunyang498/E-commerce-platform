...
const confirm=()=>{
    curAddress.value=activeAdd.value
...
<template>
    ...
    <el-dialog title="切换收货地址" width="30%" center v-model="showDialog">
        <div class="addressWrapper">
            <div class="text item" @click="switchAddress(item)" :class="{active:activeAdd.id===item.id}" v-for="item in checkInfo.userAddresses"  :key="item.id">
                <ul>
