...
const getSubCategory=async()=>{
    ...
    subCateList.value=res.result.items
}
onMounted(()=>{
    getSubCategory()
})
...
const load = async () => {
    ...
    reqData.value.page++
    const res = await getSubCategoryAPI(reqData.value)
    subCateList.value = [...subCateList.value, ...res.result.items]
    // 加载完毕 停止监听
    ...
    <div class="container ">
        ...
        <div class="sub-container">
            ...
            <div class="body" v-infinite-scroll="load" :infinite-scroll-disabled="disabled">
                <!-- 商品列表-->
                <GoodsItem v-for="good in subCateList" :good="good" :key="good.id" ></GoodsItem>
            </div>
        </div>
    </div>
</template>
